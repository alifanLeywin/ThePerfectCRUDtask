<ul class="navbar-nav bg-gradient sidebar sidebar-dark accordion" id="accordionSidebar" style="transition: all 0.3s ease;">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#" style="padding: 15px;">
        ...
        <i class="fab fa-linkedin" style="color: #f2f2f2; animation: spin 8s infinite linear;"></i>

        </div>
        <div class="sidebar-brand-text mx-4 text-light" style=" font-size: 15px; text-align: justify; ">
    Data Orang²an
</div>
    ...
    <li class="nav-item active">
        <a class="nav-link" href="{{ route('karyawan.index') }}" style="transition: all 0.3s ease;">
            <i class="fas fa-fw fa-table" style="color: #fff; transition: color 0.3s ease;"></i>
            <span style="color: #fff; transition: color 0.3s ease;">Data Karyawan</span>
        </a>
    </li>
